...
type PipelineInstanceType int32

const (
	PipelineInstanceType_Pending  PipelineInstanceType = 0
	PipelineInstanceType_Running  PipelineInstanceType = 1
	PipelineInstanceType_Complete PipelineInstanceType = 2
	PipelineInstanceType_Failed   PipelineInstanceType = 3
)

// Enum value maps for PipelineInstanceType.
var (
	PipelineInstanceType_name = map[int32]string{
		0: "Pending",
		1: "Running",
		2: "Complete",
		3: "Failed",
	}
	PipelineInstanceType_value = map[string]int32{
		"Pending":  0,
		"Running":  1,
		"Complete": 2,
		"Failed":   3,
...
func (x PipelineInstanceType) Enum() *PipelineInstanceType {
	p := new(PipelineInstanceType)
	*p = x
	return p
}

func (x PipelineInstanceType) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (PipelineInstanceType) Descriptor() protoreflect.EnumDescriptor {
	return file_v1_malou_web_proto_enumTypes[1].Descriptor()
}

func (PipelineInstanceType) Type() protoreflect.EnumType {
	return &file_v1_malou_web_proto_enumTypes[1]
}

func (x PipelineInstanceType) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use PipelineInstanceType.Descriptor instead.
func (PipelineInstanceType) EnumDescriptor() ([]byte, []int) {
...
// 创建pipelines实例
type CreatePipelineInstanceReq struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	PipelineId int64             `protobuf:"varint,1,opt,name=pipeline_id,json=pipelineId,proto3" json:"pipeline_id,omitempty"`
	RunnerCode string            `protobuf:"bytes,2,opt,name=runner_code,json=runnerCode,proto3" json:"runner_code,omitempty"`
	Env        map[string]string `protobuf:"bytes,3,rep,name=env,proto3" json:"env,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}

func (x *CreatePipelineInstanceReq) Reset() {
	*x = CreatePipelineInstanceReq{}
	if protoimpl.UnsafeEnabled {
...
func (x *CreatePipelineInstanceReq) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CreatePipelineInstanceReq) ProtoMessage() {}

func (x *CreatePipelineInstanceReq) ProtoReflect() protoreflect.Message {
	mi := &file_v1_malou_web_proto_msgTypes[19]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CreatePipelineInstanceReq.ProtoReflect.Descriptor instead.
func (*CreatePipelineInstanceReq) Descriptor() ([]byte, []int) {
	return file_v1_malou_web_proto_rawDescGZIP(), []int{19}
}

func (x *CreatePipelineInstanceReq) GetPipelineId() int64 {
	if x != nil {
		return x.PipelineId
	}
	return 0
...
func (x *CreatePipelineInstanceReq) GetRunnerCode() string {
	if x != nil {
		return x.RunnerCode
	}
	return ""
...
func (x *CreatePipelineInstanceReq) GetEnv() map[string]string {
	if x != nil {
		return x.Env
	}
	return nil
...
type CreatePipelineInstanceResp struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	Status             PipelineInstanceType `protobuf:"varint,2,opt,name=status,proto3,enum=PipelineInstanceType" json:"status,omitempty"`
}

func (x *CreatePipelineInstanceResp) Reset() {
	*x = CreatePipelineInstanceResp{}
	if protoimpl.UnsafeEnabled {
...
func (x *CreatePipelineInstanceResp) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CreatePipelineInstanceResp) ProtoMessage() {}

func (x *CreatePipelineInstanceResp) ProtoReflect() protoreflect.Message {
	mi := &file_v1_malou_web_proto_msgTypes[20]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CreatePipelineInstanceResp.ProtoReflect.Descriptor instead.
func (*CreatePipelineInstanceResp) Descriptor() ([]byte, []int) {
	return file_v1_malou_web_proto_rawDescGZIP(), []int{20}
}

func (x *CreatePipelineInstanceResp) GetPipelineInstanceId() string {
	if x != nil {
...
func (x *CreatePipelineInstanceResp) GetStatus() PipelineInstanceType {
	if x != nil {
		return x.Status
	}
	return PipelineInstanceType_Pending
}
...
func (x *PipelineInstanceLogListReq) Reset() {
	*x = PipelineInstanceLogListReq{}
	if protoimpl.UnsafeEnabled {
		mi := &file_v1_malou_web_proto_msgTypes[21]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*PipelineInstanceLogListReq) Descriptor() ([]byte, []int) {
	return file_v1_malou_web_proto_rawDescGZIP(), []int{21}
}
...
func (x *PipelineInstanceLogListResp) Reset() {
	*x = PipelineInstanceLogListResp{}
	if protoimpl.UnsafeEnabled {
		mi := &file_v1_malou_web_proto_msgTypes[22]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*PipelineInstanceLogListResp) Descriptor() ([]byte, []int) {
	return file_v1_malou_web_proto_rawDescGZIP(), []int{22}
}
...
var file_v1_malou_web_proto_rawDesc = []byte{
	...
	,
	...
	,
	...
	0x65, 0x72, 0x2f, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x12, 0x52, 0x0a, 0x0a, 0x52, 0x75, 0x6e,
	...
	0x49, 0x6e, 0x66, 0x6f, 0x52, 0x65, 0x73, 0x70, 0x22, 0x23, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x1d,
	...
	0x6e, 0x65, 0x72, 0x2f, 0x6c, 0x69, 0x73, 0x74, 0x12, 0x59, 0x0a, 0x0e, 0x43, 0x72, 0x65, 0x61,
	0x74, 0x65, 0x50, 0x69, 0x70, 0x65, 0x6c, 0x69, 0x6e, 0x65, 0x12, 0x12, 0x2e, 0x43, 0x72, 0x65,
	0x61, 0x74, 0x65, 0x50, 0x69, 0x70, 0x65, 0x6c, 0x69, 0x6e, 0x65, 0x52, 0x65, 0x71, 0x1a, 0x13,
	...
	,
...
var file_v1_malou_web_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_v1_malou_web_proto_msgTypes = make([]protoimpl.MessageInfo, 28)
var file_v1_malou_web_proto_goTypes = []interface{}{
	(RunnerStatusType)(0),               // 0: RunnerStatusType
	(PipelineInstanceType)(0),           // 1: PipelineInstanceType
	(*CreateRunnerReq)(nil),             // 2: CreateRunnerReq
	(*CreateRunnerResp)(nil),            // 3: CreateRunnerResp
	(*UpdateRunnerReq)(nil),             // 4: UpdateRunnerReq
	(*UpdateRunnerResp)(nil),            // 5: UpdateRunnerResp
	(*RunnerInfoReq)(nil),               // 6: RunnerInfoReq
	(*RunnerInfoHealth)(nil),            // 7: RunnerInfoHealth
	(*RunnerInfoResp)(nil),              // 8: RunnerInfoResp
	(*RunnerListReq)(nil),               // 9: RunnerListReq
	(*RunnerListItem)(nil),              // 10: RunnerListItem
	(*RunnerListResp)(nil),              // 11: RunnerListResp
	(*CreatePipelineReq)(nil),           // 12: CreatePipelineReq
	(*CreatePipelineResp)(nil),          // 13: CreatePipelineResp
	(*UpdatePipelineReq)(nil),           // 14: UpdatePipelineReq
	(*UpdatePipelineResp)(nil),          // 15: UpdatePipelineResp
	(*PipelineInfoReq)(nil),             // 16: PipelineInfoReq
	(*PipelineInfoResp)(nil),            // 17: PipelineInfoResp
	(*PipelineListReq)(nil),             // 18: PipelineListReq
	(*PipelineListItem)(nil),            // 19: PipelineListItem
	(*PipelineListResp)(nil),            // 20: PipelineListResp
	(*CreatePipelineInstanceReq)(nil),   // 21: CreatePipelineInstanceReq
	(*CreatePipelineInstanceResp)(nil),  // 22: CreatePipelineInstanceResp
	(*PipelineInstanceLogListReq)(nil),  // 23: PipelineInstanceLogListReq
	(*PipelineInstanceLogListResp)(nil), // 24: PipelineInstanceLogListResp
	nil,                                 // 25: CreateRunnerReq.EnvEntry
	nil,                                 // 26: UpdateRunnerReq.EnvEntry
	nil,                                 // 27: RunnerInfoHealth.WorkerStatusEntry
	nil,                                 // 28: RunnerInfoResp.EnvEntry
	nil,                                 // 29: CreatePipelineInstanceReq.EnvEntry
	(*MemoryInfo)(nil),                  // 30: MemoryInfo
	(*DiskInfo)(nil),                    // 31: DiskInfo
	(*Step)(nil),                        // 32: Step
	(*PipelineInstanceLog)(nil),         // 33: PipelineInstanceLog
}
var file_v1_malou_web_proto_depIdxs = []int32{
	25, // 0: CreateRunnerReq.env:type_name -> CreateRunnerReq.EnvEntry
	26, // 1: UpdateRunnerReq.env:type_name -> UpdateRunnerReq.EnvEntry
	30, // 2: RunnerInfoHealth.memory_info:type_name -> MemoryInfo
	31, // 3: RunnerInfoHealth.disk_info:type_name -> DiskInfo
	27, // 4: RunnerInfoHealth.worker_status:type_name -> RunnerInfoHealth.WorkerStatusEntry
	28, // 5: RunnerInfoResp.env:type_name -> RunnerInfoResp.EnvEntry
	7,  // 6: RunnerInfoResp.health:type_name -> RunnerInfoHealth
	0,  // 7: RunnerInfoResp.status:type_name -> RunnerStatusType
	10, // 8: RunnerListResp.data:type_name -> RunnerListItem
	32, // 9: CreatePipelineReq.steps:type_name -> Step
	32, // 10: UpdatePipelineReq.steps:type_name -> Step
	32, // 11: PipelineInfoResp.steps:type_name -> Step
	19, // 12: PipelineListResp.data:type_name -> PipelineListItem
	29, // 13: CreatePipelineInstanceReq.env:type_name -> CreatePipelineInstanceReq.EnvEntry
	1,  // 14: CreatePipelineInstanceResp.status:type_name -> PipelineInstanceType
	33, // 15: PipelineInstanceLogListResp.log:type_name -> PipelineInstanceLog
	2,  // 16: MalouWeb.CreateRunner:input_type -> CreateRunnerReq
	4,  // 17: MalouWeb.UpdateRunner:input_type -> UpdateRunnerReq
	6,  // 18: MalouWeb.RunnerInfo:input_type -> RunnerInfoReq
	9,  // 19: MalouWeb.RunnerList:input_type -> RunnerListReq
	12, // 20: MalouWeb.CreatePipeline:input_type -> CreatePipelineReq
	14, // 21: MalouWeb.UpdatePipeline:input_type -> UpdatePipelineReq
	16, // 22: MalouWeb.PipelineInfo:input_type -> PipelineInfoReq
	18, // 23: MalouWeb.PipelineList:input_type -> PipelineListReq
	21, // 24: MalouWeb.CreatePipelineInstance:input_type -> CreatePipelineInstanceReq
	23, // 25: MalouWeb.PipelineInstanceLogList:input_type -> PipelineInstanceLogListReq
	3,  // 26: MalouWeb.CreateRunner:output_type -> CreateRunnerResp
	5,  // 27: MalouWeb.UpdateRunner:output_type -> UpdateRunnerResp
	8,  // 28: MalouWeb.RunnerInfo:output_type -> RunnerInfoResp
	11, // 29: MalouWeb.RunnerList:output_type -> RunnerListResp
	13, // 30: MalouWeb.CreatePipeline:output_type -> CreatePipelineResp
	15, // 31: MalouWeb.UpdatePipeline:output_type -> UpdatePipelineResp
	17, // 32: MalouWeb.PipelineInfo:output_type -> PipelineInfoResp
	20, // 33: MalouWeb.PipelineList:output_type -> PipelineListResp
	22, // 34: MalouWeb.CreatePipelineInstance:output_type -> CreatePipelineInstanceResp
	24, // 35: MalouWeb.PipelineInstanceLogList:output_type -> PipelineInstanceLogListResp
...
func file_v1_malou_web_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_v1_malou_web_proto_msgTypes[19].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CreatePipelineInstanceReq); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_v1_malou_web_proto_msgTypes[20].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CreatePipelineInstanceResp); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_v1_malou_web_proto_msgTypes[21].Exporter = func(v interface{}, i int) interface{} {
		...
		file_v1_malou_web_proto_msgTypes[22].Exporter = func(v interface{}, i int) interface{} {
