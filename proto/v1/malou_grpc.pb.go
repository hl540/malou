...
func (c *malouClient) RegisterRunner(ctx context.Context, in *RegisterRunnerReq, opts ...grpc.CallOption) (*RegisterRunnerResp, error) {
	...
	err := c.cc.Invoke(ctx, Malou_RegisterRunner_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *malouClient) Heartbeat(ctx context.Context, in *HeartbeatReq, opts ...grpc.CallOption) (*HeartbeatResp, error) {
	...
	err := c.cc.Invoke(ctx, Malou_Heartbeat_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *malouClient) PullPipeline(ctx context.Context, in *PullPipelineReq, opts ...grpc.CallOption) (*PullPipelineResp, error) {
	...
	err := c.cc.Invoke(ctx, Malou_PullPipeline_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *malouClient) ReportPipelineLog(ctx context.Context, opts ...grpc.CallOption) (Malou_ReportPipelineLogClient, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Malou_ServiceDesc.Streams[0], Malou_ReportPipelineLog_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &malouReportPipelineLogClient{ClientStream: stream}
	return x, nil
}
...
func _Malou_ReportPipelineLog_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(MalouServer).ReportPipelineLog(&malouReportPipelineLogServer{ServerStream: stream})
}
