...
type Malou_ReportPipelineLogClient interface {
	Send(*PipelineInstanceLog) error
...
func (x *malouReportPipelineLogClient) Send(m *PipelineInstanceLog) error {
...
type Malou_ReportPipelineLogServer interface {
	...
	Recv() (*PipelineInstanceLog, error)
	grpc.ServerStream
}
...
func (x *malouReportPipelineLogServer) Recv() (*PipelineInstanceLog, error) {
	m := new(PipelineInstanceLog)
