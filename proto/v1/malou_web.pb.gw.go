...
func RegisterMalouWebHandlerServer(ctx context.Context, mux *runtime.ServeMux, server MalouWebServer) error {
	...
	mux.Handle("GET", pattern_MalouWeb_PipelineLogList_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/.MalouWeb/PipelineLogList", runtime.WithHTTPPathPattern("/v1/pull/{pipeline_id}/log/{index}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterMalouWebHandlerClient(ctx context.Context, mux *runtime.ServeMux, client MalouWebClient) error {
	...
	mux.Handle("GET", pattern_MalouWeb_PipelineLogList_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/.MalouWeb/PipelineLogList", runtime.WithHTTPPathPattern("/v1/pull/{pipeline_id}/log/{index}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	...
	pattern_MalouWeb_PipelineLogList_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"v1", "pull", "pipeline_id", "log", "index"}, ""))
)
