...
func request_MalouWeb_PipelineList_0(ctx context.Context, marshaler runtime.Marshaler, client MalouWebClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq PipelineListReq
	var metadata runtime.ServerMetadata
	...
	msg, err := client.PipelineList(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_MalouWeb_PipelineList_0(ctx context.Context, marshaler runtime.Marshaler, server MalouWebServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq PipelineListReq
	var metadata runtime.ServerMetadata
	...
	msg, err := server.PipelineList(ctx, &protoReq)
	return msg, metadata, err

}

func request_MalouWeb_CreatePipelineInstance_0(ctx context.Context, marshaler runtime.Marshaler, client MalouWebClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq CreatePipelineInstanceReq
	var metadata runtime.ServerMetadata
	...
	msg, err := client.CreatePipelineInstance(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_MalouWeb_CreatePipelineInstance_0(ctx context.Context, marshaler runtime.Marshaler, server MalouWebServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq CreatePipelineInstanceReq
	var metadata runtime.ServerMetadata
	...
	msg, err := server.CreatePipelineInstance(ctx, &protoReq)
	return msg, metadata, err
...
func RegisterMalouWebHandlerServer(ctx context.Context, mux *runtime.ServeMux, server MalouWebServer) error {
	...
	mux.Handle("POST", pattern_MalouWeb_PipelineList_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/.MalouWeb/PipelineList", runtime.WithHTTPPathPattern("/v1/pipeline/list"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_MalouWeb_PipelineList_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_MalouWeb_PipelineList_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)

	})

	mux.Handle("POST", pattern_MalouWeb_CreatePipelineInstance_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/.MalouWeb/CreatePipelineInstance", runtime.WithHTTPPathPattern("/v1/pipeline_instance/create"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_MalouWeb_CreatePipelineInstance_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_MalouWeb_CreatePipelineInstance_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterMalouWebHandlerClient(ctx context.Context, mux *runtime.ServeMux, client MalouWebClient) error {
	...
	mux.Handle("POST", pattern_MalouWeb_PipelineList_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/.MalouWeb/PipelineList", runtime.WithHTTPPathPattern("/v1/pipeline/list"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_MalouWeb_PipelineList_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
	...
	mux.Handle("POST", pattern_MalouWeb_CreatePipelineInstance_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/.MalouWeb/CreatePipelineInstance", runtime.WithHTTPPathPattern("/v1/pipeline_instance/create"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_MalouWeb_CreatePipelineInstance_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	...
	pattern_MalouWeb_PipelineList_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1", "pipeline", "list"}, ""))

	pattern_MalouWeb_CreatePipelineInstance_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1", "pipeline_instance", "create"}, ""))
...
var (
	...
	forward_MalouWeb_PipelineList_0 = runtime.ForwardResponseMessage

	forward_MalouWeb_CreatePipelineInstance_0 = runtime.ForwardResponseMessage
